...
TEST_F(Test_wholth_sql_statements_exercise_log_insert, should_report_errors)
{
    ...
    std::vector<_Case> cases = {
        ...
        {{wtsv("-1")},
         ...
         {},
         {},
         {"Идентификатор упраженения не валиден!"}},
        // 3
        {{wtsv("4b")},
         {},
         {},
        ...
        {{wtsv("1")},
         ...
         {},
         {},
         {"Не удалось найти пользователя с таким идентификатором!"}},
        // 7
        {{wtsv("1")},
         {wtsv("1")},
         {wtsv("-10")},
...
TEST_F(Test_wholth_sql_statements_exercise_log_insert, should_save_data)
{
    ...
    std::vector<_Case> cases = {
        // 0
        {{wtsv("1")}, {wtsv("2")}, {wtsv("10")}, {}, "1,1,2,10,", ""},
        // 1
        {{wtsv("1")}, {wtsv("2")}, {wtsv("40b")}, {}, "1,1,2,40,", ""},
        // 2
        {{wtsv("1")}, {wtsv("3")}, {wtsv("19.3")}, {}, "1,1,3,19,", ""},
        // 3
        {{wtsv("1")},
         {wtsv("3")},
         {wtsv("19.3")},
