...
class Test_wholth_sql_statements_ingredient_delete : public ApplicationAwareTest
{
    void SetUp() override
    {
...
TEST_F(Test_wholth_sql_statements_ingredient_delete, when_args_is_nullptr)
{
...
TEST_F(Test_wholth_sql_statements_ingredient_delete, when_bad_id)
{
    auto& con = db::connection();
...
TEST_F(Test_wholth_sql_statements_ingredient_delete, when_binds_is_nullptr)
{
    auto& con = db::connection();
...
TEST_F(Test_wholth_sql_statements_ingredient_delete, when_binds)
{
    auto& con = db::connection();
...
TEST_F(Test_wholth_sql_statements_ingredient_delete, when_good_case)
{
    auto& con = db::connection();
    ...
    ASSERT_STRNE3(old_count, new_count);
    ...
    astmt(
        ...
        "WHERE id = 102",
        [&](auto e) { check = e.column_value; });
    ASSERT_STREQ2("bogus", check) << "Record should be deleted!";
}

TEST_F(
    Test_wholth_sql_statements_ingredient_delete,
    when_binds_size_neq_bind_vector_size)
{
    auto& con = db::connection();
